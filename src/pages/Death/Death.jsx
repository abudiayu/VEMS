...
export default function Death() {
  ...
  const handlePrint = async (id) => {
    try {
      const res = await deathService.generateCertificate(id);
  ...
  const columns = [
    ...
    { header: 'Deceased Name',  accessor: 'deceased_name' },
    { header: 'Date of Death',  accessor: 'date_of_death' },
  ...
  return (
    <div className="page">
      <div className="page__header">
        ...
        <Button icon={FiPlus} onClick={() => { setEditRecord(null); setShowForm(true); }}>Register Death</Button>
      </div>

      <DataTable columns={columns} data={data?.records || []} loading={loading} searchable searchPlaceholder="Search death records..." emptyMessage="No death records found." />

      {showForm && (
        <DeathForm record={editRecord}
      ...
      {deleteId && (
        <div className="modal-overlay">
          <div className="modal modal--sm">
            ...
            <p className="modal__text">Are you sure you want to delete this death record? This cannot be undone.</p>
