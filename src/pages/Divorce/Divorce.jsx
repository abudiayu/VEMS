      ...
      render: (row) => (
        <div className="table-actions">
          <button className="table-action-btn table-action-btn--view" title="View"
            onClick={() => { setEditRecord(row); setShowForm(true); }}><FiEye size={15} /></button>
          ...
          <button className="table-action-btn table-action-btn--print" title="Print"
            onClick={() => handlePrint(row.id)}><FiPrinter size={15} /></button>
        ...
        <div className="modal-overlay">
          <div className="modal modal--sm">
            ...
            <p className="modal__text">
              Are you sure you want to delete this divorce record? This cannot be undone.
            </p>
