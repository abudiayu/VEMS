...
const initialState = {
  ...
  role: '', password: '', confirm_password: '', status: 'active',
};

export default function UserForm({ record, onClose, onSuccess }) {
  const isEdit = !!record;
  const [form, setForm]           = useState(record ? { ...record, password: '', confirm_password: '' } : initialState);
          ...
          <div className="modal__body">
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <FormField label="Email Address" name="email" type="email" value={form.email} onChange={handleChange} error={errors.email} required placeholder="Enter email" />
                <FormField label="Role" name="role" type="select" value={form.role} onChange={handleChange} error={errors.role} required
                  options={[{ value: 'admin', label: 'System Administrator' }, { value: 'employee', label: 'Employee' }, { value: 'customer', label: 'Customer' }]} />
