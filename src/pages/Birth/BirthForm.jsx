...
const initialState = {
  child_name: '', date_of_birth: '', place_of_birth: '',
  gender: '', father_name: '', father_id_no: '',
  mother_name: '', mother_id_no: '', kebele: '', woreda: '', notes: '',
};
    ...
    <div className="modal-overlay">
      <div className="modal modal--lg">
        <div className="modal__header">
          <h3 className="modal__title">{isEdit ? 'Edit Birth Record' : 'Register Birth Event'}</h3>
